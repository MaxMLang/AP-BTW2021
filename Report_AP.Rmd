...
ergebnis_erststimmen <- ergebnisse_table %>%
  ...
  ggtitle(label = "Entgültige Erststimmen der Bundestagswahl 2021") +
...
ergebnis_zweitstimmen <- ergebnisse_table %>%
  ...
  ggtitle(label = "Entgültige Zweitstimmen der Bundestagswahl 2021") +
  scale_y_continuous(labels = scales::percent,
                     breaks = scales::pretty_breaks(n = 10),
                     limits = c(0,0.3))
...
diff_zweitstimmen <- ergebnisse_table %>%
  ...
  ggtitle(label = "Differenz an Prozentpunkten der Zweitstimmen zwischen der Bundestagswahl 2017 und 2021 je Partei") +
  scale_y_continuous(labels = scales::percent,
                     breaks = scales::pretty_breaks(n = 10),
                     limits = c(-0.1, 0.1)) +
...
ggsave("MM_Erst_Zweit_Rest.png", path = "Grafiken", width = 9, height = 5)
