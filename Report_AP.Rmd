...
ezd_union <- btw_trimmed_data %>%
  ...
  geom_point(aes(x = Union.Erst.End.Perc, y = Union.Zweit.End.Perc), 
             fill = partei_colors["CDU/CSU"], color = "black", 
             shape = 21, alpha = 0.5)+
...
ezd_spd <- btw_trimmed_data %>%
  ggplot()+
  geom_abline(linetype = "longdash", color = "#666666")+
  geom_point(aes(x = SPD.Erst.End.Perc, y = SPD.Zweit.End.Perc), shape = 21, 
             fill = partei_colors["SPD"], color = "black", alpha = 0.5)+
  scale_x_continuous(labels = scales::percent,
                     limits = c(0, 0.55))+
  scale_y_continuous(labels = scales::percent,
                     limits = c(0, 0.55))+
...
ezd_gruene <- btw_trimmed_data %>%
  ggplot()+
  geom_abline(linetype = "longdash", color = "#666666")+
  geom_point(aes(x = GRÜNE.Erst.End.Perc, y = GRÜNE.Zweit.End.Perc), shape = 21, 
             fill = partei_colors["Grüne"], color = "black", alpha = 0.5)+
  scale_x_continuous(labels = scales::percent,
                     limits = c(0, 0.4))+
  scale_y_continuous(labels = scales::percent,
                     limits = c(0, 0.4))+
  labs(x = "Erststimmanteile (in %)") +
  ggtitle("GRÜNE")

ezd_afd <- btw_trimmed_data %>%
  ggplot()+
  geom_abline(linetype = "longdash", color = "#666666")+
  geom_point(aes(x = AFD.Erst.End.Perc, y = AFD.Zweit.End.Perc), shape = 21, 
             fill = partei_colors["AFD"], color = "black", alpha = 0.5)+
  scale_x_continuous(labels = scales::percent,
                     limits = c(0, 0.4))+
  scale_y_continuous(labels = scales::percent,
                     limits = c(0, 0.4))+
...
ezd_fdp <- btw_trimmed_data %>%
  ggplot()+
  geom_abline(linetype = "longdash", color = "#666666")+
  geom_point(aes(x = FDP.Erst.End.Perc, y = FDP.Zweit.End.Perc), shape = 21, 
             fill = partei_colors["FDP"], color = "black", alpha = 0.3)+
  scale_x_continuous(labels = scales::percent,
                     limits = c(0, 0.4))+
  scale_y_continuous(labels = scales::percent,
                     limits = c(0, 0.4))+
...
ezd_linke <- btw_trimmed_data %>%
  ggplot()+
  geom_abline(linetype = "longdash", color = "#666666")+
  geom_point(aes(x = LINKE.Erst.End.Perc, y = LINKE.Zweit.End.Perc), shape = 21, 
             fill = partei_colors["Linke"], color = "black", alpha = 0.5)+
  scale_x_continuous(labels = scales::percent,
                     limits = c(0, 0.4))+
  scale_y_continuous(labels = scales::percent,
                     limits = c(0, 0.4))+
...
MM_Erst_Zweit_CDU_SPD <- ggarrange(ezd_union, ezd_spd, label.y = c(rep(1, 6)), 
                                   label.x = rep(0.3, 6))
annotate_figure(MM_Erst_Zweit_CDU_SPD, top = text_grob("Erststimmen vs. Zweitstimmen", 
                                                       color = "black", size = 14))

ggsave("MM_Erst_Zweit_CDU_SPD.png", path = "Grafiken", width = 9, height = 5)

#Zusammenfuegen der Plot der anderen Parteien
MM_Erst_Zweit_Rest <- ggarrange(ezd_afd, ezd_fdp, ezd_linke, ezd_gruene, 
                                label.y = c(rep(1, 6)), label.x = rep(0.3, 6))
annotate_figure(MM_Erst_Zweit_Rest, top = text_grob("Erststimmen vs. Zweitstimmen", 
                                                    color = "black", size = 14))
