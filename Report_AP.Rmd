...
ez_union <- btw_trimmed_data %>%
  ggplot()+
  geom_boxplot(aes(y = Union.Erst.Zweit.Diff.Perc), fill = "black", 
...
ez_linke <- btw_trimmed_data %>% 
  ggplot()+
  geom_boxplot(aes(x = "", y = LINKE.Erst.Zweit.Diff.Perc), fill = "purple")
...
ezd_union <- btw_trimmed_data %>%
  ggplot()+
  geom_point(aes(x = Union.Erst.End.Perc, y = Union.Zweit.End.Perc))+
  scale_x_continuous(limits = c(0, 0.55))+
  scale_y_continuous(limits = c(0, 0.55))
ezd_spd <- btw_trimmed_data %>%
  ggplot()+
  geom_point(aes(x = SPD.Erst.End.Perc, y = SPD.Zweit.End.Perc))+
  scale_x_continuous(limits = c(0, 0.55))+
  scale_y_continuous(limits = c(0, 0.55))
ezd_gruene <- btw_trimmed_data %>%
  ggplot()+
  geom_point(aes(x = GRÜNE.Erst.End.Perc, y = GRÜNE.Zweit.End.Perc))+
  scale_x_continuous(limits = c(0, 0.55))+
  scale_y_continuous(limits = c(0, 0.55))

ezd_afd <- btw_trimmed_data %>%
  ggplot()+
  geom_point(aes(x = AFD.Erst.End.Perc, y = AFD.Zweit.End.Perc))+
  scale_x_continuous(limits = c(0, 0.4))+
  scale_y_continuous(limits = c(0, 0.4))
ezd_fdp <- btw_trimmed_data %>%
  ggplot()+
  geom_point(aes(x = FDP.Erst.End.Perc, y = FDP.Zweit.End.Perc))+ #alpha
  scale_x_continuous(limits = c(0, 0.4))+
  scale_y_continuous(limits = c(0, 0.4))
ezd_linke <- btw_trimmed_data %>%
  ggplot()+
  geom_point(aes(x = LINKE.Erst.End.Perc, y = LINKE.Zweit.End.Perc))+
  scale_x_continuous(limits = c(0, 0.4))+
  scale_y_continuous(limits = c(0, 0.4))

ggarrange(ezd_union, ezd_spd, ezd_gruene, ezd_fdp, ezd_afd, ezd_linke)
