...
ezd_union <- btw_trimmed_data %>%
  ggplot()+
  geom_point(aes(x = Union.Erst.End.Perc, y = Union.Zweit.End.Perc), color = "black", shape = 21)+
...
ezd_gruene <- btw_trimmed_data %>%
  ggplot()+
  geom_point(aes(x = GRÜNE.Erst.End.Perc, y = GRÜNE.Zweit.End.Perc), shape = 21, fill = "green", color = "black")+
  scale_x_continuous(limits = c(0, 0.55))+
  scale_y_continuous(limits = c(0, 0.55))+
  labs(x = NULL, y = NULL)
ezd_afd <- btw_trimmed_data %>%
  ggplot()+
  geom_point(aes(x = AFD.Erst.End.Perc, y = AFD.Zweit.End.Perc), shape = 21, fill = "blue", color = "black")+
  scale_x_continuous(limits = c(0, 0.4))+
  scale_y_continuous(limits = c(0, 0.4))+
  labs(x = "Erststimmen in %", y = NULL)
ezd_fdp <- btw_trimmed_data %>%
  ggplot()+
  geom_point(aes(x = FDP.Erst.End.Perc, y = FDP.Zweit.End.Perc), shape = 21, fill = "yellow", color = "black")+ #alpha
  scale_x_continuous(limits = c(0, 0.4))+
  scale_y_continuous(limits = c(0, 0.4))+
  labs(x = "", y = "Zweitstimmen in %")
ezd_linke <- btw_trimmed_data %>%
  ggplot()+
  geom_point(aes(x = LINKE.Erst.End.Perc, y = LINKE.Zweit.End.Perc), shape = 21, fill = "purple", color = "black")+
  scale_x_continuous(limits = c(0, 0.4))+
  scale_y_continuous(limits = c(0, 0.4))+
  labs(x = "", y = NULL)
