...
btw_kerg_trimmed_bundeslaender <- btw_test %>%
  mutate(Union.Erst.Vor = CDU.Erst.Vor + CSU.Erst.Vor,
         ...
         Union.Zweit.End = CDU.Zweit.End + CDU.Zweit.End,
...
btw_kerg_trimmed_bundeslaender$CDU.Zweit.End.Perc
btw_test <- btw_kerg_trimmed_bundeslaender
btw_test[is.na(btw_test)] <- 0
btw_test <- btw_test %>%
  mutate(Union.Erst.Vor = CDU.Erst.Vor + CSU.Erst.Vor,
         Union.Erst.End = CDU.Erst.End + CSU.Erst.End,
         Union.Erst.End.Perc = CDU.Erst.End.Perc + CSU.Erst.End.Perc,
...
```{r}
a <- btw_trimmed_geo_data %>% 
  select(Wahlkreis.Nr, CDU.Erst.End, CSU.Erst.End, SPD.Erst.End)
